...
class BaseOption(object):
    def __init__(self):
        ...
        self.parser.add_argument('--gpu_ids', type=str, default="0,1", help='gpu number. If -1, use cpu')

        #----------------------------------------------------------------------
        # data setting
        
        self.parser.add_argument('--dataset_name', type=str, default='pix2pixCC', help='dataset directory name')
        self.parser.add_argument('--data_format_input', type=str, default='fits', help="Input data extension. [tif, tiff, png, jpg, jpeg, npy, fits, fts, fit]")
        self.parser.add_argument('--data_format_target', type=str, default='fits', help="Target data extension. [tif, tiff, png, jpg, jpeg, npy, fits, fts, fit]")
        
        self.parser.add_argument('--input_ch', type=int, default=2, help="The number of channels of input data")
        ...
        self.parser.add_argument('--batch_size', type=int, default=5, help='the number of batch_size')
        ...
        self.parser.add_argument('--n_workers', type=int, default=8, help='how many threads you want to use')
        ...
        self.parser.add_argument('--report_freq', type=int, default=3475)
        self.parser.add_argument('--save_freq', type=int, default=3475)
        self.parser.add_argument('--display_freq', type=int, default=6950)
...
class TrainOption(BaseOption):
    def __init__(self):
        ...
        self.parser.add_argument('--input_dir_train', type=str, default='/userhome/youn_j/Dataset/EUV/AIA_prepV7.1/171_304_concat', help='directory path of the input files for the model training')
        self.parser.add_argument('--target_dir_train', type=str, default='/userhome/youn_j/Dataset/EUV/AIA_prepV7.1/211', help='directory path of the target files for the model training')
        
        #----------------------------------------------------------------------
        # Train setting
        
        self.parser.add_argument('--is_train', type=bool, default=True, help='train flag')
        self.parser.add_argument('--n_epochs', type=int, default=450, help='how many epochs you want to train')
        ...
        self.parser.add_argument('--lambda_CC', type=float, default=8.0, help='weight for CC loss')
...
class TestOption(BaseOption):
    def __init__(self):
        ...
        self.parser.add_argument('--input_dir_test', type=str, default='/userhome/youn_j/Dataset/EUV/EUI_prepV8_231129/caseV8.1/174_304_concat', help='directory path of the input files for the model test')
